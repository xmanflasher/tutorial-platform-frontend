            ...
            <div className="fixed bottom-6 right-6 z-[9999] flex flex-col items-end gap-3">
                <div className="group relative">
                    <div className="absolute bottom-16 right-0 opacity-0 translate-y-4 pointer-events-none group-hover:opacity-100 group-hover:translate-y-0 group-hover:pointer-events-auto transition-all duration-300 mb-2 flex flex-col gap-2 scale-95 group-hover:scale-100 origin-bottom-right">
                        <div className="bg-[#1a1c1e] border border-border-ui rounded-xl p-4 shadow-2xl w-64 backdrop-blur-md">
                            <div className="text-white font-bold text-sm mb-3 flex items-center gap-2 border-b border-border-ui pb-2">
                            ...
                            {user ? (
                                <div className="grid grid-cols-1 gap-2">
                                    <button
                                        ...
                                        className="text-[11px] bg-primary/20 hover:bg-primary text-black py-2 px-3 rounded-lg text-left transition-colors flex items-center justify-between"
                                    >
                                        <span>重啟功能導覽</span>
                                    ...
                                    <button
                                        ...
                                        className="text-[11px] bg-amber-600/20 hover:bg-amber-600 text-amber-100 py-2 px-3 rounded-lg text-left transition-colors flex items-center justify-between disabled:opacity-50"
                                    >
                                    ...
                                    >
                                        <span className="flex items-center gap-2">
                                            {isSimulating ? <Loader2 className="w-3 h-3 animate-spin" /> : null}
                                            Σ-導讀精靈：快速批改 (Simulate Correction)
                                        </span>
                                        <ChevronRight className="w-3 h-3" />
                                    </button>
                                    <button
                            ...
                            <div className="mt-3 pt-2 border-t border-border-ui text-[10px] text-gray-400">
                    ...
                    <button
                        onClick={openGuide}
                        className="flex items-center gap-3 bg-primary hover:opacity-90 text-black p-3 rounded-full shadow-2xl transition-all hover:scale-105 active:scale-95 relative"
                        title="閱讀導覽"
                    >
            ...
            <div className="bg-[#1a1c1e] border border-border-ui rounded-2xl w-full max-w-2xl overflow-hidden shadow-2xl relative">
                ...
                {step === 'role-selection' && (
                    <div className="p-8 text-center pt-12">
                        <h2 className="text-3xl font-bold text-white mb-2">歡迎進入 Σ-Codeatl</h2>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {[
                                ...
                                <button
                                    ...
                                    className="flex flex-col items-center justify-center p-6 rounded-xl bg-white/5 border border-border-ui hover:bg-white/10 hover:border-border-ui transition-all group"
                                >
                    ...
                    <div className="flex flex-col h-[500px]">
                        <div className="p-6 border-b border-border-ui flex justify-between items-center bg-white/5 pt-8">
                            <div>
                                ...
                                <p className="text-xs text-primary mt-1 font-medium">STEP {guideIndex + 1} OF {GUIDE_STEPS.length}</p>
                            </div>
                        </div>
                        ...
                        <div className="p-6 border-t border-border-ui flex justify-between items-center bg-white/5">
                            <button
                                ...
                                {GUIDE_STEPS.map((_, idx) => (
                                    <div
                                        ...
                                        className={cn(
                                            ...
                                            idx === guideIndex ? "w-6 bg-primary" : "bg-white/20"
                                        )}
                                    />
                                ))}
                            </div>
                            ...
                            <button
                                ...
                                className="flex items-center gap-2 px-6 py-2 bg-primary hover:opacity-90 text-black rounded-lg transition-all shadow-lg shadow-primary/20 active:scale-95"
                            >
