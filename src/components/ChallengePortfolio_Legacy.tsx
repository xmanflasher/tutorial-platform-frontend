 ...
 * 邏輯：直接從 /gym-challenge-records/user/${targetUserId} 抓取資料
 * 不含本地 LocalStorage 的合併邏輯。
 */
...
export default function ChallengePortfolioLegacy({ targetUserId, onRecordsLoaded }: ChallengePortfolioProps) {
