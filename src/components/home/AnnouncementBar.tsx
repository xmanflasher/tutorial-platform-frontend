...
export default function AnnouncementBar({ data: initialData }: { data: Announcement }) {
  ...
  return (
    <div className="w-full bg-card border border-border-ui rounded-lg p-4 flex flex-col md:flex-row items-center justify-between gap-4 mb-8">
      ...
      {announcement.linkHref && (
        <Link
          ...
          className="px-6 py-1.5 bg-primary hover:opacity-90 text-black text-sm font-bold rounded transition-colors whitespace-nowrap"
        >
