...
export const MOCK_LEADERBOARD: LeaderboardUser[] = [
  { id: 1, rank: 1, name: 'Elliot', title: '初級工程師', level: 19, score: 31040, avatar: 'E' },
  { id: 2, rank: 2, name: '精靈Ken Lin', title: '初級工程師', level: 18, score: 29130, avatar: 'K' },
  { id: 3, rank: 3, name: 'Clark Chen', title: '初級工程師', level: 17, score: 27260, avatar: 'C' },
  { id: 4, rank: 4, name: 'Adam Huang', title: '初級工程師', level: 16, score: 25440, avatar: 'A' },
  { id: 5, rank: 5, name: '酥炸香菇天婦羅', title: '初級工程師', level: 16, score: 25374, avatar: 'S' },
  { id: 6, rank: 6, name: 'Bella Wu', title: '初級工程師', level: 15, score: 24050, avatar: 'B' },
  { id: 7, rank: 7, name: 'David Lee', title: '初級工程師', level: 15, score: 23890, avatar: 'D' },
  { id: 8, rank: 8, name: 'Fiona Chang', title: '初級工程師', level: 14, score: 22560, avatar: 'F' },
  { id: 9, rank: 9, name: 'George Wang', title: '初級工程師', level: 14, score: 22340, avatar: 'G' },
  { id: 10, rank: 10, name: 'Hannah Lin', title: '初級工程師', level: 13, score: 21020, avatar: 'H' },
];
